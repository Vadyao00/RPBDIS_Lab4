...
namespace RPBDIS_Lab4.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "EmployeeShowtime",
                columns: table => new
                {
                    EmployeesEmployeeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ShowtimesShowtimeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeShowtime", x => new { x.EmployeesEmployeeId, x.ShowtimesShowtimeId });
                    table.ForeignKey(
                        name: "FK_EmployeeShowtime_Employees_EmployeesEmployeeId",
                        column: x => x.EmployeesEmployeeId,
                        principalTable: "Employees",
                        principalColumn: "EmployeeId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeShowtime_Showtimes_ShowtimesShowtimeId",
                        column: x => x.ShowtimesShowtimeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeShowtime_ShowtimesShowtimeId",
                table: "EmployeeShowtime",
                column: "ShowtimesShowtimeId");
